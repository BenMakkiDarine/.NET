...
namespace GUI.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> RegisterAgent(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, Name = model.Name, Last_Name = model.Last_Name };
                ...
                if (result.Succeeded)
                {
                    ...
                    MailMessage mm = new MailMessage(currentUser.Email, currentUser.Email, "Email confirmation ", "Dear " + currentUser.Name+ " Please confirm your email on this link : <a href=" + callbackUrl + ">here</a>");
